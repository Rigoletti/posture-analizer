...
// Вынесенные константы для табов (не пересоздаются при рендерах)
const TABS = [
...
// Вынесенные константы для футера
const FOOTER_ITEMS = [
  { icon: (
...
const ProfileLayout: React.FC<ProfileLayoutProps> = ({ children, title, subtitle }) => {
  ...
  // Мемоизация проверки активности
  const isActive = (path: string) => location.pathname === path;

  // Мемоизация стилей фона
  ...
  // Мемоизация стилей радиального градиента
  ...
  // Мемоизация стилей для карточки контента
  ...
  return (
    <Box sx={backgroundStyle}>
      {/* Статический фон без анимации */}
      <Box sx={radialGradientStyle} />
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        {/* Header - без анимаций Fade/Grow/Zoom */}
        <Box sx={{ mb: 4 }}>
          <Stack 
          ...
          >
            ...
            {/* Кнопка "На главную" - без анимации Zoom */}
            <Box
              component={Link}
              to="/"
              sx={{
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Индикатор активной вкладки - без анимации motion */}
                  {active && (
                    <Box
                      sx={{
                        position: 'absolute',
        ...
        {/* Main Content - без анимации Grow */}
        <Box sx={{ mb: 4 }}>
          {/* Заголовок страницы */}
          <Stack 
            direction="row" 
          ...
          >
            ...
            {/* Декоративные точки - без анимации motion */}
          ...
          {/* Карточка с контентом - без эффекта свечения с анимацией */}
